...
7. Before any pilot, add bounded abandoned-reservation reconciliation, authenticated usage/invoice reconciliation, token-unit budgets, a separate atomic start/lease contract, independent security review and the issue #15 adversarial run evidence.
