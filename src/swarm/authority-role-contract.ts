...
export const BROKER_DATABASE_ROLE_CONTRACT = Object.freeze({
  ...
  table_grants: [
    ...
    'swarm_authority_usage_evidence:INSERT',
    'swarm_authority_usage_evidence:SELECT',
    'swarm_authority_usage_tokens:INSERT',
  ...
  column_updates: [
    ...
    'swarm_authority_reservations:provider_usage_correlation_id',
    ...
    'swarm_authority_reservations:usage_reconciliation_token_sha256',
